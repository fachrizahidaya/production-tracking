...
class StenterService extends BaseCrudService<Stenter> {
  StenterService()
      : super(
          endpoint: 'stenters',
          fromJson: (json) => Stenter.fromJson(json),
