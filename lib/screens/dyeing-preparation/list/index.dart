...
import 'package:textile_tracking/screens/dyeing-preparation/create/create_dyeing_preparation.dart';
import 'package:textile_tracking/screens/dyeing-preparation/detail/dyeing_preparation_by_id.dart';
...
class DyeingPreparationScreen extends StatefulWidget {
  const DyeingPreparationScreen({super.key});

  @override
  State<DyeingPreparationScreen> createState() =>
      _DyeingPreparationScreenState();
}

class _DyeingPreparationScreenState extends State<DyeingPreparationScreen> {
  ...
  Future<void> _intializeMenus() async {
    ...
    setState(() {
      _canRead = _userMenu.checkMenu('Persiapan Dyeing', 'read');
      _canDelete = _userMenu.checkMenu('Persiapan Dyeing', 'delete');
      _canUpdate = _userMenu.checkMenu('Persiapan Dyeing', 'update');
  ...
  Future<void> _openProcessDetail(
    ...
    final value = await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) {
          if (isInProgress) {
            return EditDyeingPreparationScreen(id: item['id'].toString());
          }

          return DyeingPreparationDetailScreen(
            id: item['id'].toString(),
                  ...
                  child: ProcessList(
                    ...
                    onItemTap: (context, item) {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DyeingPreparationDetailScreen(
                              id: item['id'].toString(),
                              no: item['prep_no'].toString(),
                              canDelete: _canDelete,
                              canUpdate: _canUpdate,
                            ),
                          )).then((value) {
