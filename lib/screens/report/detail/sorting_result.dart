...
class SortingResultDetailScreen extends StatefulWidget {
  ...
  const SortingResultDetailScreen({
    super.key,
  ...
  @override
  State<SortingResultDetailScreen> createState() =>
      _SortingResultDetailScreenState();
}

class _SortingResultDetailScreenState extends State<SortingResultDetailScreen> {
  final ReportService _reportService = ReportService();
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  final List<SortingResultItem> _items = [];
