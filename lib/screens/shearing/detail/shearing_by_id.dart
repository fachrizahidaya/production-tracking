...
class _ShearingDetailScreenState extends State<ShearingDetailScreen> {
  ...
  Future<void> _handleDelete(Map<String, dynamic> data) async {
    ...
    showConfirmationDialog(
      context: context,
      title: 'Hapus Data',
      message: 'Apakah Anda yakin ingin menghapus proses shearing?',
      ...
      builder: (context, constraints) {
        ...
        final deleteButton = canDelete && data['can_delete'] != false
            ? ElevatedButton.icon(
                ...
                label: const Text('Hapus Shearing'),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Lihat ringkasan proses Shearing dan item Persiapan Produksi.',
                    style: TextStyle(
        ...
        final left = Column(
          children: [
            ...
            _DetailCard(
              ...
              title: 'Hasil Shearing',
              child: _ResultSection(data: data),
            ),
            _DetailCard(
              icon: Icons.event_note_outlined,
              title: 'Catatan Shearing',
