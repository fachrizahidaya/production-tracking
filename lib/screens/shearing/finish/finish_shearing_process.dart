...
class FinishShearingProcess extends StatefulWidget {
  final String title;
  ...
  @override
  State<FinishShearingProcess> createState() => _FinishShearingProcessState();
}

class _FinishShearingProcessState extends State<FinishShearingProcess> {
    ...
    try {
      ...
      if (option == null) {
        showAlertDialog(
          context: context,
          title: 'Error',
          message: 'Greige Order Shearing tidak ditemukan',
        );
        setState(() => _isLoading = false);
        return;
      }
      ...
      final processId = option['shearing_id']?.toString();
