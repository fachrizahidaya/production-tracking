...
class EditSizingScreen extends StatefulWidget {
  final dynamic id;

  const EditSizingScreen({
    super.key,
    required this.id,
  });

  @override
  State<EditSizingScreen> createState() => _EditSizingScreenState();
}

class _EditSizingScreenState extends State<EditSizingScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      final service = Provider.of<SizingService>(context, listen: false);
  ...
  Future<void> _fetchMachine(dynamic currentMachineId) async {
    ...
    try {
      ...
      await service.fetchOptionsSizing(
        currentMachineIds:
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      final message = await Provider.of<SizingService>(context, listen: false)
          .updateItem(context, widget.id.toString(), sizing, _isSubmitting);
  ...
  Future<void> _handleCancel() async {
    showConfirmationDialog(
      ...
      title: 'Batal Edit Proses Sizing',
  ...
  Widget _buildSummaryCard() {
    ...
    return TemplateCard(
      title: 'Informasi Sizing',
      icon: Icons.assignment_outlined,
      child: Column(
        children: [
          _InfoLine('No. Sizing', _display(_data['sizing_no'])),
