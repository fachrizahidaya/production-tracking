...
class FinishTumbler extends StatefulWidget {
  const FinishTumbler({super.key});

  @override
  State<FinishTumbler> createState() => _FinishTumblerState();
}

class _FinishTumblerState extends State<FinishTumbler> {
  ...
  Widget build(BuildContext context) {
    return FinishProcess(
      ...
      handleSubmitToService: (context, id, form, isLoading) async {
        ...
        showAlertDialog(
            context: context, title: 'Tumbler Finished', message: message);
