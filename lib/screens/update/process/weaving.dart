...
class _WeavingSectionState extends State<WeavingSection> {
  ...
  void _handleGreigeWeight(int index, String value) {
    final safeValue = value.toString().trim().isEmpty ? '0' : value.toString();

    widget.onChange(index, 'greige_weight', safeValue);
  ...
  void _handleWasteWeight(int index, String value) {
    final safeValue = value.toString().trim().isEmpty ? '0' : value.toString();

    widget.onChange(index, 'waste_weight', safeValue);
          ...
          children: [
            SizedBox(
              ...
              child: TextForm(
                ...
                initialValue: item['greige_weight']?.toString() ?? '0',
                req: false,
                isNumber: true,
                isSorting: true,
                handleChange: (value) => _handleGreigeWeight(index, value),
              ),
            ),
            SizedBox(
              width: isTablet
              ...
              child: TextForm(
                ...
                initialValue: item['waste_weight']?.toString() ?? '0',
                isNumber: true,
                isSorting: true,
                handleChange: (value) => _handleWasteWeight(index, value),
              ),
            ),
          ].separatedBy(CustomTheme().hGap('xl')),
        ),
