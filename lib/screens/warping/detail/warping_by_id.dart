      ...
      builder: (context, constraints) {
        ...
        final deleteButton = canDelete && data['can_delete'] != false
            ? ElevatedButton.icon(
                ...
                label: const Text('Hapus Warping'),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Lihat ringkasan proses Warping dan item Persiapan Produksi.',
                    style: TextStyle(
...
class _ResultSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        _InfoRow('Jenis Warping', _formatType(data['warping_type'])),
        _InfoRow('Qty Benang', _withUnit(data['yarn_qty'], 'KG')),
        _InfoRow('Panjang', _withUnit(data['length'], 'M')),
        _InfoRow('Jumlah Section', _withUnit(data['section'], '')),
            ...
            children: [
              Expanded(
                child: _InfoRow(
                  ...
                  _display(data['ne']),
                  trailing:
                      _SmallChip(_formatType(orderGreige['warping_type'])),
                ),
              ),
              Expanded(child: _InfoRow('Lot', _display(data['lot']))),
            ],
          ),
        ],
      ),
