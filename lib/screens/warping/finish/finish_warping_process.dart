...
class FinishWarpingProcess extends StatefulWidget {
  final String title;
  ...
  @override
  State<FinishWarpingProcess> createState() => _FinishWarpingProcessState();
}

class _FinishWarpingProcessState extends State<FinishWarpingProcess> {
    ...
    try {
      ...
      if (option == null) {
        showAlertDialog(
          context: context,
          title: 'Error',
          message: 'Greige Order Warping tidak ditemukan',
        );
        setState(() => _isLoading = false);
        return;
      }
      ...
      final processId = option['warping_id']?.toString();
