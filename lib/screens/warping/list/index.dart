...
class WarpingScreen extends StatefulWidget {
  const WarpingScreen({super.key});

  @override
  State<WarpingScreen> createState() => _WarpingScreenState();
}

class _WarpingScreenState extends State<WarpingScreen> {
  ...
  Future<void> _intializeMenus() async {
    ...
    setState(() {
      _canRead = _userMenu.checkMenu('Warping', 'read');
      _canDelete = _userMenu.checkMenu('Warping', 'delete');
      _canUpdate = _userMenu.checkMenu('Warping', 'update');
  ...
  Future<void> _loadMore() async {
    ...
    List<dynamic> loadData =
        Provider.of<WarpingService>(context, listen: false).items;
