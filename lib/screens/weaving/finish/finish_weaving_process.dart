...
class FinishWeavingProcess extends StatefulWidget {
  final String title;
  ...
  @override
  State<FinishWeavingProcess> createState() => _FinishWeavingProcessState();
}

class _FinishWeavingProcessState extends State<FinishWeavingProcess> {
    ...
    try {
      ...
      if (option == null) {
        showAlertDialog(
          context: context,
          title: 'Error',
          message: 'Greige Order Weaving tidak ditemukan',
        );
        setState(() => _isLoading = false);
        return;
      }
      ...
      final processId = option['weaving_id']?.toString();
